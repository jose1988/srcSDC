...
@NamedQueries({
    ...
    @NamedQuery(name = "Alerta.findPaquetesVencidosXSeguimiento", query = "SELECT a.seguimiento.idpaq FROM Alerta a WHERE a.seguimiento.statusseg='0' AND a.seguimiento.iduse= :usuarioSede  ANd a.seguimiento.idpaq.statuspaq ='0' AND a.seguimiento.nivelseg!='Valija' "),
